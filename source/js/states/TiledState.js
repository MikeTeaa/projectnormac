...
Platformer.TiledState.prototype.init_hud = function () {
    ...
    lives_position = new Phaser.Point(this.game.world.width * 0.5, 20);
    lives = new Platformer.Lives(this, lives_position, {"texture": "player_spritesheet", "group": "hud", "frame": 4, "spacing": 10});
